...
describe('DayPickerWithModifiers', () => {
  describe('#render()', () => {
    it('renders <DayPicker />', () => {
      const wrapper = shallow(<DayPickerWithModifiers />);
  ...
  describe('#onDayClick', () => {
    describe('day argument is a blocked day', () => {
      it('props.onFocusChange is not called', () => {
        ...
        const wrapper = shallow(<DayPickerWithModifiers onFocusChange={onFocusChangeStub} />);
      ...
      it('props.onDatesChange is not called', () => {
        ...
        const wrapper = shallow(<DayPickerWithModifiers onDatesChange={onDatesChangeStub} />);
        wrapper.instance().onDayClick(today, ['blocked']);
    ...
    describe('props.focusedInput === START_DATE', () => {
      describe('props.onFocusChange', () => {
        it('is called once', () => {
          ...
          const wrapper = shallow(
            <DayPickerWithModifiers focusedInput={START_DATE} onFocusChange={onFocusChangeStub} />
          );
      ...
      it('calls props.onDatesChange', () => {
        const onDatesChangeStub = sinon.stub();
        const wrapper = shallow(
          <DayPickerWithModifiers focusedInput={START_DATE} onDatesChange={onDatesChangeStub} />
        );
        wrapper.instance().onDayClick(today, []);
        ...
        describe('props.onFocusChange', () => {
          describe('props.startDate === null', () => {
            it('is called once', () => {
              const onFocusChangeStub = sinon.stub();
              const wrapper = shallow(
                <DayPickerWithModifiers focusedInput={END_DATE} onFocusChange={onFocusChangeStub} />
              );
              wrapper.instance().onDayClick(today, []);
              expect(onFocusChangeStub.callCount).to.equal(1);
            });
  ...
  describe('day modifier methods', () => {
    ...
    describe('#isDayAfterHoveredStartDate', () => {
      it('returns true if arg startDate is hovered and arg is the day after the startDate', () => {
        const wrapper = shallow(<DayPickerWithModifiers startDate={today} />);
        wrapper.setState({
          hoverDate: today,
        });
      ...
      it('returns false if props.startDate is falsey', () => {
        const testDate = moment(today).add(1, 'days');
        const wrapper = shallow(<DayPickerWithModifiers startDate={null} />);
        wrapper.setState({
          hoverDate: today,
        });
      ...
      it('returns false if arg is day after state.hoverDate and props.minimumNights is 0', () => {
        const testDate = moment(today).add(1, 'days');
        const wrapper = shallow(<DayPickerWithModifiers startDate={today} minimumNights={0} />);
        wrapper.setState({
          hoverDate: today,
        });
        expect(wrapper.instance().isDayAfterHoveredStartDate(testDate)).to.equal(false);
    ...
    describe('#isEndDate', () => {
      it('returns true if arg === props.endDate', () => {
        const wrapper = shallow(<DayPickerWithModifiers endDate={today} />);
        expect(wrapper.instance().isEndDate(today)).to.equal(true);
      });

      it('returns false if arg !== props.endDate', () => {
        const wrapper = shallow(<DayPickerWithModifiers endDate={moment(today).add(1, 'days')} />);
    ...
    describe('#isInHoveredSpan', () => {
      describe('props.endDate === null', () => {
        it('returns true if arg is in between props.startDate and state.hoverDate', () => {
          ...
          const wrapper = shallow(<DayPickerWithModifiers startDate={today} endDate={null} />);
          wrapper.setState({
    ...
    describe('#isLastInRange', () => {
      ...
      beforeEach(() => {
        isInSelectedSpanStub = sinon.stub(DayPickerWithModifiers.prototype, 'isInSelectedSpan');
      });
    ...
    describe('#isStartDate', () => {
      ...
      it('returns false if arg !== props.startDate', () => {
        const wrapper =
          shallow(<DayPickerWithModifiers startDate={moment(today).add(1, 'days')} />);
    ...
    describe('#isBlocked', () => {
      ...
      beforeEach(() => {
        ...
        doesNotMeetMinimumNightsStub =
          sinon.stub(DayPickerWithModifiers.prototype, 'doesNotMeetMinimumNights');
      });
