...
export default class DayPickerWithModifiers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hoverDate: null,
...
DayPickerWithModifiers.propTypes = propTypes;
DayPickerWithModifiers.defaultProps = defaultProps;
