	  ...
	  _createClass(DateRangePicker, [{
	    ...
	    value: function () {
	      function responsivizePickerPosition() {
	        ...
	        var anchorDirection = _props9.anchorDirection;
	        var horizontalMargin = _props9.horizontalMargin;
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var onPrevMonthClick = _props16.onPrevMonthClick;
	        var onNextMonthClick = _props16.onNextMonthClick;
	    ...
	    value: function () {
	      function render() {
	        ...
	        var startDate = _props17.startDate;
	        var endDate = _props17.endDate;
	        var focusedInput = _props17.focusedInput;
	        var showClearDates = _props17.showClearDates;
	        var disabled = _props17.disabled;
	        var required = _props17.required;
	        var startDateId = _props17.startDateId;
	        var endDateId = _props17.endDateId;
	        var phrases = _props17.phrases;
	        var withPortal = _props17.withPortal;
	        var withFullScreenPortal = _props17.withFullScreenPortal;

	        var startDateString = this.getDateString(startDate);
	        var endDateString = this.getDateString(endDate);

	        return _react2['default'].createElement('div', { className: 'DateRangePicker' }, _react2['default'].createElement(_DateRangePickerInput2['default'], {
	          ref: function () {
	            function ref(_ref3) {
	              _this3.input = _ref3;
	            }
