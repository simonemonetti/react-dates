...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultProps = {
	  ...
	  disabledDays: [],
	  minimumDate: (0, _moment2['default'])(),
	  isOutsideRange: function () {
	    function isOutsideRange(day, minimumDate) {
	      return !(0, _isInclusivelyAfterDay2['default'])(day, minimumDate);
	    }
	  ...
	  _createClass(SingleDatePicker, [{
	    ...
	    value: function () {
	      function onChange(dateString) {
	        ...
	        var isValid = date && !isOutsideRange(date, minimumDate);
	        if (isValid) {
	          onDateChange(date);
	    ...
	    value: function () {
	      function isBlocked(day) {
	        ...
	        var minimumDate = _props6.minimumDate;
	    ...
	    value: function () {
	      function renderDayPicker() {
	        ...
	        var minimumDate = _props8.minimumDate;
	        var dayPickerContainerStyles = this.state.dayPickerContainerStyles;
	        ...
	        var modifiers = {
	          ...
	          'blocked-out-of-range': function () {
	            function blockedOutOfRange(day) {
	              return isOutsideRange(day, minimumDate);
	            }
